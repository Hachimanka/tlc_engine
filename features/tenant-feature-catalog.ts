...
const higherEducationFeatures: FeatureDefinition[] = [
  ...
  },
  {
    ...
    description: "Create rooms and assign approved subjects to room schedules.",
    group: "Academic Operations",
    institutionType: "higher_ed",
    status: "active",
...
const tesdaFeatures: FeatureDefinition[] = [
  {
    ...
    description: "Plan batch schedules using required training hours, shifts, and delivery modes.",
    group: "TESDA Trainer Workspace",
    institutionType: "tesda",
    status: "active",
    href: "/tenant/tesda/calendar",
    iconName: "settings",
  },
  {
    key: "tesda-trainers",
    label: "Teaching Load",
    description: "View assigned batches, courses, training sessions, and weekly trainer load.",
    group: "TESDA Trainer Workspace",
    institutionType: "tesda",
    status: "active",
    href: "/tenant/tesda/teaching-load",
    iconName: "people",
  },
  {
    key: "tesda-training-hours-compliance",
    label: "Workload",
    description: "Track planning, teaching, demonstrations, supervision, and documentation work.",
    group: "TESDA Trainer Workspace",
    institutionType: "tesda",
    status: "active",
    href: "/tenant/tesda/workload",
    iconName: "signal",
  },
  {
    key: "tesda-qualifications",
    label: "Competency-Based Curriculum",
    description: "Maintain TESDA training regulations, competencies, and training hours.",
    group: "TESDA Curriculum",
    institutionType: "tesda",
    status: "active",
    href: "/tenant/tesda/curriculum",
    iconName: "file",
  },
  {
    key: "tesda-trainee-records",
    label: "Trainee Progress",
    description: "Track attendance, materials, outputs, and competency progress per trainee.",
    group: "TESDA Trainer Workspace",
    institutionType: "tesda",
    status: "active",
    href: "/tenant/tesda/progress",
    iconName: "files",
  },
  {
    key: "tesda-competency-assessment",
    label: "Competency Assessment",
    description: "Manage checklists, evidence, and assessment methods for each competency.",
    group: "TESDA Trainer Workspace",
    institutionType: "tesda",
    status: "active",
    href: "/tenant/tesda/assessment",
    iconName: "shield",
  },
  {
    key: "tesda-assessment-results",
    label: "Assessment Results",
    description: "Record competent and not yet competent outcomes from TESDA-style assessments.",
    group: "TESDA Trainer Workspace",
    institutionType: "tesda",
    status: "active",
    href: "/tenant/tesda/assessment-results",
  ...
  },
  {
    ...
    description: "Generate completion records, certificates, and TESDA reports.",
    group: "Compliance",
    institutionType: "tesda",
    status: "active",
    href: "/tenant/tesda/reports",
    iconName: "download",
  },
];
