      ...
      <div className="mx-auto w-full max-w-[1120px] space-y-3">
        ...
        <div className="flex justify-end pt-2">
          ...
          >
            <span
              aria-hidden="true"
              className="absolute inset-x-0 inset-y-0 translate-x-1.5 translate-y-1.5 rounded-[18px] bg-[var(--color-default)] transition-transform duration-200 group-hover:translate-x-2 group-hover:translate-y-2"
            />
