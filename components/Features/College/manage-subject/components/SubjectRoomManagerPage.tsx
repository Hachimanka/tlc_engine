...
export default function SubjectRoomManagerPage() {
  ...
  return (
    <div className="flex min-h-[640px] w-full overflow-hidden rounded-2xl bg-[#F3F3F1]">
      {/* Sidebar */}
      <aside className="w-[230px] bg-white flex flex-col shrink-0 border-r border-gray-200">
        {/* User info */}
