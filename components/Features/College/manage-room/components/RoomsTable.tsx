...
export default function RoomsTable() {
  ...
  const [newRoom, setNewRoom] = useState<NewRoomForm>({ name: "", building: "", type: "Lecture Room", capacity: 30 });
      ...
      {showAddRoom && (
        <div className="overflow-hidden rounded-[8px] border border-[var(--color-default)] bg-white shadow-level-1 p-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            ] satisfies Array<{ label: string; key: keyof Pick<NewRoomForm, "name" | "building">; placeholder: string; type: string }>).map(({ label, key, placeholder, type }) => (
              <div key={key}>
